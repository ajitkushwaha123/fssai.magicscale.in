...
export default function StickyMobileCTA() {
  ...
  return (
    <>
      ...
      >
        <div className="border-t border-blue-100 bg-white/95 backdrop-blur-xl supports-[backdrop-filter]:bg-white/80">
          <div className="mx-auto max-w-lg px-4 py-3 pb-[calc(env(safe-area-inset-bottom)+12px)]">
            <div className="flex items-center justify-between gap-2">
              <div className="flex flex-col shrink-0">
                <span className="text-2xl min-[375px]:text-3xl font-black tracking-tight text-blue-600">
              ...
              <div className="w-full max-w-[160px] min-[375px]:max-w-[180px] ml-auto">
                <PayButton className="w-full text-sm h-10 min-[375px]:h-11 shadow-lg shadow-blue-500/25 bg-blue-600 hover:bg-blue-700" />
              </div>
            </div>
          </div>
        </div>
